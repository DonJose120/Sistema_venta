                ...
                <div class="col-md-10">
                    <div style="text-align:left">
                        ...
                        <div class="my-10 shadow  mb-10 bg-body-tertiary rounded">
                            ...
                            <a href="{{ route('clientes.create') }}"> <button type="submit" class="btn btn-dark btn-block text-light" style="padding: 7px 20px;">New Cliente</button></a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="display: flex;">
                                            <a href="{{ route('clientes.edit', $cliente) }}"> <button type="submit" class="btn btn-dark " style="padding: 6px 22px;">Edit</button></a>

                                            <form Action="{{ route('clientes.delete', $cliente) }}" method="post" style="margin-left: 10px;"> <button type="submit" class="btn btn-dark btn-block">Delete</button></button>
                                            </form>
                                        </td>
                                    </tr>
                                    @empty
